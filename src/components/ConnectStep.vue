<template>
    <v-container class="d-flex justify-space-between flex-column flex-grow-1">
        <div class="mb-10 mt-n4">
            <h6 class="text-h6 pb-4">Conecta tu dispositivo</h6>

            <div class="text-body-1">
                <p>
                    Presiona volumen - mas power para entrar en modo fastboot e instalar LineageOS 18.1
                </p>
                <p>
                    Cuando el disposiitvo este en modo fastboot conectalo!
                    a
                </p>
            </div>
