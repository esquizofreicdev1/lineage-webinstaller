<template>
    <v-container class="d-flex justify-space-between flex-column flex-grow-1">
        <div class="mt-n4">
            <h6 class="text-h6 pb-4">Descargue una compilacion de LineageOS 18.1</h6>

            <div class="text-body-1">
                <p>
                    Selecciona una compilacion de LineageOS 18.1 para descargar e instalar.
                </p>
            </div>
        </div>
        ...
        <div class="text-center" v-else-if="latestReleases === undefined">
            <p class="text-h5 red--text text--darken-3">
                Tu dispositivo no esta soportado
            </p>
            <p class="text-body-1">Solo estos dispositivos estan soportados:</p>
